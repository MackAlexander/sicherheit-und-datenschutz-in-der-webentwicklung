...
class Log
{
    ...
    private static function render_access_log()
    {
        ...
        //$logs = \THM\Own\Database::get_access_log(); //Änderung vorgenommen
        $logs = \THM\Own\Database::get_access_log();
        \THM\Own\Database::append_access_log($_SERVER['REMOTE_ADDR'], $_SERVER['REQUEST_URI']);
    ...
    public static function log_access()
    {
        ...
        \THM\Own\Database::append_access_log($_SERVER['REMOTE_ADDR'], $_SERVER['REQUEST_URI']); //Änderung vorgenommen
    }
}
